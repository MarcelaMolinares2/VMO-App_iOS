...
extension Color {
    ...
    static let cTextLight = Color("colorTextLight")
    static let cTextHigh = Color("colorTextHigh")
    ...
    static let cPanelDiary = Color("colorPanelDiary")
    static let cPanelExpense = Color("colorPanelExpense")
    static let cPanelGroup = Color("colorPanelGroup")
    static let cPanelMaterial = Color("colorPanelMaterial")
    static let cPanelMedic = Color("colorPanelMedic")
    static let cPanelOrder = Color("colorPanelOrder")
    static let cPanelPatient = Color("colorPanelPatient")
